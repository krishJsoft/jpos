...
public class SalesReturnLazySorter implements Comparator<SalesorderreturnModel> {

	private String sortField;
	private SortOrder sortOrder;

	public SalesReturnLazySorter(String sortField, SortOrder sortOrder) {
		this.sortField = sortField;
		this.sortOrder = sortOrder;
	}

	public int compare(SalesorderreturnModel t1, SalesorderreturnModel t2) {
		try {
			Field f = SalesorderModel.class.getDeclaredField(this.sortField);
