...
public class CustomerLazySorter implements Comparator<CustomerModel> {
	...
	public int compare(CustomerModel t1, CustomerModel t2) {
		try {
			Field f = CustomerModel.class.getDeclaredField(this.sortField);
