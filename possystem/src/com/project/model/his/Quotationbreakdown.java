 ...
 */
@Entity
@Table(name="quotationbreakdown")
public class Quotationbreakdown implements Serializable {
	...
	@OneToMany(mappedBy="quotationbreakdown")
	private List<Salesorderbreakdown> salesorderbreakdowns;

	public Quotationbreakdown() {
	}
	...
	public Salesorderbreakdown addSalesorderbreakdown(Salesorderbreakdown salesorderbreakdown) {
		...
		salesorderbreakdown.setQuotationbreakdown(this);
	...
	public Salesorderbreakdown removeSalesorderbreakdown(Salesorderbreakdown salesorderbreakdown) {
		...
		salesorderbreakdown.setQuotationbreakdown(null);
