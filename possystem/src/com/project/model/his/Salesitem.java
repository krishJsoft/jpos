...
/**
 * The persistent class for the salesitem database table.
 * 
 */
@Entity
...
public class Salesitem implements Serializable {
	...
	// bi-directional many-to-one association to Salesitembreakdown
	@OneToMany(mappedBy = "salesorder", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	private List<Salesitembreakdown> salesorderbreakdowns;
	...
	public List<Salesitembreakdown> getSalesorderbreakdowns() {
		return salesorderbreakdowns;
	}

	public void setSalesorderbreakdowns(
			List<Salesitembreakdown> salesorderbreakdowns) {
