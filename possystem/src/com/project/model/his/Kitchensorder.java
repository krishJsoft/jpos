 ...
 */
@Entity
@Table(name = "kitchensorder")
public class Kitchensorder implements Serializable {
...
//	@OneToMany(mappedBy = "salesorder", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	...
	@OneToMany(mappedBy = "salesorder", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	private List<Kitchenorderbreakdown> salesorderbreakdowns;

	public Kitchensorder() {
	}
...
//	}
	...
	public List<Kitchenorderbreakdown> getSalesorderbreakdowns() {
		return this.salesorderbreakdowns;
	}

	public void setSalesorderbreakdowns(
			List<Kitchenorderbreakdown> salesorderbreakdowns) {
