...
/**
 * The persistent class for the branchinvoicebreakdown database table.
 * 
 */
@Entity
@Table(name="branchinvoicebreakdown")
public class Branchinvoicebreakdown implements Serializable {
