...
/**
 * The persistent class for the branchiteminvoice database table.
 * 
 */
@Entity
@Table(name = "branchiteminvoice")
public class Branchiteminvoice implements Serializable {
	...
	private List<Branchiteminvoicebreakdown> branchinvoicebreakdowns;

	public Branchiteminvoice() {
	}
	...
	public List<Branchiteminvoicebreakdown> getBranchinvoicebreakdowns() {
		return branchinvoicebreakdowns;
	}

	public void setBranchinvoicebreakdowns(
			List<Branchiteminvoicebreakdown> branchinvoicebreakdowns) {
