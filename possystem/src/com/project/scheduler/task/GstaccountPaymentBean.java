...
import com.project.model.paginghelper.GstaccountPaymentPagingHelper;
...
@ManagedBean(name = "gstaccountpaymentBean")
@SessionScoped
public class GstaccountPaymentBean {
	...
	private LazyDataModel<GstaccountPaymentModel> gstaccountModel = null;

	GstaccountPaymentModel gstpayment = new GstaccountPaymentModel();
	...
	public void setStaffId(Integer staffId) {
	 ...
	 public LazyDataModel<GstaccountPaymentModel> getGstaccountModel() {
		return gstaccountModel;
	}

	public void setGstaccountModel(LazyDataModel<GstaccountPaymentModel> gstaccountModel) {
	...
	public GstaccountPaymentModel getGstpayment() {
		return gstpayment;
	}

	public void setGstpayment(GstaccountPaymentModel gstpayment) {
		this.gstpayment = gstpayment;
	}

	public LazyDataModel<GstaccountPaymentModel> getGstAccountList() {
		FacesContext context = FacesContext.getCurrentInstance();
		try
		{		
		this.setGstaccountModel(null);	
		gstaccountModel = new GstaccountPaymentPagingHelper(loginBean.getBranch().getBranchId(),dateFrom, dateTo,status,gstaccounBO);		
