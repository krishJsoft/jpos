...
public interface IConfiguration {
	...
	public static final String PRODUCT_GST_AMOUNT = "project.gst.amount";
	public static final String PRODUCT_DEFAULTGST_AMOUNT = "project.defaultgst.amount";

	public static final String PRODUCT_GST_NUMBER = "project.gst.number";
	public static final String PRODUCT_REG_NUMBER = "project.reg.number";
	...
	public static final String DELIVERYORDER_STATUS_CLOSED_VALUE = "deliveryorder.status.closedvalue";
	public static final String DELIVERYORDER_STATUS_CLOSED_LABLE = "deliveryorder.status.closedlable";
	public static final String DELIVERYORDER_STATUS_CANCEL_VALUE = "deliveryorder.status.cancelledvalue";
	public static final String DELIVERYORDER_STATUS_CANCEL_LABLE = "deliveryorder.status.cancelledlable";
