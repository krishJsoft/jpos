...
public class Backup {
    ...
    public String getData(String host, String port, String user, String password, String db,String URL) {
        String Mysqlpath = getMysqlBinPath(user, password, db,URL);
        try {
    ...
    public String getMysqlBinPath(String user, String password, String db,String URL) {
        try {
            Class.forName("com.mysql.jdbc.Driver");
        } catch (Exception e) {
            e.printStackTrace();
